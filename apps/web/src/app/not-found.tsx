      ...
      <div className="w-full max-w-md text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-5 py-3 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50 dark:bg-gray-950 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300"
          >
