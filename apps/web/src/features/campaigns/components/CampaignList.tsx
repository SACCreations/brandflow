  ...
  return (
    <div className="grid gap-4">
      {campaigns.map((campaign) => {
        ...
        return (
          <div key={campaign.id} className="glass-panel p-6 group hover:border-brand-500/50 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between gap-6">
              <div className="flex-1 space-y-4">
                ...
                <div className="flex flex-wrap gap-6 text-sm text-gray-500 dark:text-gray-400">
                  <div className="flex items-center gap-2 bg-white/50 dark:bg-gray-800/50 px-3 py-1.5 rounded-lg border border-border/50 backdrop-blur-sm">
              ...
              <div className="flex flex-col justify-between items-end min-w-[200px] border-t md:border-t-0 md:border-l border-border/50 pt-4 md:pt-0 md:pl-6">
                <div className="w-full space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-gray-500 dark:text-gray-400 font-medium">Campaign Health</span>
                  ...
                  <div className="flex justify-between items-center text-sm pt-2">
                    <span className="text-gray-500 dark:text-gray-400 font-medium">Budget Spent</span>
                ...
                <div className="flex items-center gap-3 w-full mt-6">
                  <Link href={`/campaigns/${campaign.id}`} className="flex-1 text-center py-2 bg-brand-50 hover:bg-brand-100 dark:bg-brand-500/10 dark:hover:bg-brand-500/20 text-brand-700 dark:text-brand-300 rounded-lg text-sm font-bold transition-colors">
                    Manage
                  </Link>
                  <button className="p-2 border border-border/50 hover:border-gray-300 dark:hover:border-gray-600 rounded-lg text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-all bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
