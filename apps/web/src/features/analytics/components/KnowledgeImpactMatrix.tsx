...
export function KnowledgeImpactMatrix({ topSources }: KnowledgeImpactMatrixProps) {
  return (
    <div className="lg:col-span-12 overflow-hidden glass-panel">
      <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50 px-6 py-4 backdrop-blur-sm">
          ...
          <tbody className="divide-y divide-gray-50 dark:divide-gray-800/50">
            {(topSources ?? []).length ? (
              topSources!.map((source, index) => {
                ...
                return (
                  <tr key={source.sourceId} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/40 transition-colors">
